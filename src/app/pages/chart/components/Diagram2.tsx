...
export function Diagram2() {
  const chartRef: MutableRefObject<HTMLDivElement | null> = useRef<HTMLDivElement | null>(null);

  useEffect(() => {
    const chartDiv: HTMLDivElement = chartRef.current as HTMLDivElement;
    const chart = new FamilyTree(chartDiv, {
